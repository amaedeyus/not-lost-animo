    ...
    if ($stmt->execute()) {
        echo '<div class="custom-alert-overlay">
                <div class="custom-alert success">
                    ...
                    <div class="message">
                        <h2 style="margin: 0 0 10px 0; color: #4CAF50;">Waiting for Approval</h2>
                        <p style="margin: 0;">Your item has been submitted and is pending staff approval.</p>
                        <p style="margin: 10px 0 0 0; font-size: 14px; color: #666;">Once approved, your item will appear in the main lost items list.</p>
                    </div>
                    <div class="buttons">
                        <button class="confirm-btn" onclick="redirectToMain()">Return to Home</button>
                    </div>
                </div>
              </div>';
    } else {
...
function redirectToMain() {
    window.location.href = 'item-main.php';
}
</script>
